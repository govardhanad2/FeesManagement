...
public class JsonDBExample {
	...
	public static void main(String[] args) throws Exception{
		...
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/json", "root", "Chitti@123");

		for(int i=0; i<mList.size(); i++) {
			DXCEmployee mObject = mList.get(i);
			
			PreparedStatement stmtInsert = con.prepareStatement("insert into json_tbl values(?,?)");
